...
Clients should identify themselves with a unique User-Agent header, for example YourBotName/1.0 (your-danbooru-username). Don't impersonate browsers or use the default header of your library.
