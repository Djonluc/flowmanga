            ...
            {visible && (
                ...
                >
                    ...
                    <div className="flex items-center gap-6 min-w-0">
                        <button 
                            onClick={onBack}
                            className="w-10 h-10 rounded-full bg-white/5 flex items-center justify-center text-white hover:bg-accent transition-all hover:scale-110 active:scale-90 border border-white/5 group"
                        >
                        ...
                        <div className="flex flex-col gap-0 min-w-0">
                            ...
                            <h1 className="text-lg font-black text-white leading-tight truncate uppercase italic tracking-tighter">
                                {title}
                            </h1>
                        </div>
                    </div>
                         ...
                         {mode === 'vertical' && (
                             <button
                                ...
                                className={clsx(
                                    ...
                                    autoScroll 
                                        ? "bg-accent border-accent text-white shadow-[0_0_32px_rgba(59,130,246,0.3)]" 
