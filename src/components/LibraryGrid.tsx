...
const ContextMenu = ({
  ...
  return (
    <div className="fixed inset-0 z-[100]" role="button" tabIndex={0} aria-label="Close menu" onClick={onClose} onKeyDown={event => { if (event.key === 'Escape' || event.key === 'Enter') onClose(); }}>
      <motion.div
